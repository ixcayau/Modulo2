...
public class UsuarioSQLiteHelper extends SQLiteOpenHelper {
        ...
        String sqlCreate = "CREATE TABLE Usuario (codigo INTEGER, nombre TEXT, usuario TEXT, contrasena TEXT);";

        public UsuarioSQLiteHelper(Context contexto, String nombre, CursorFactory factory, int version) {
