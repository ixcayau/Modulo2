...
/**
 * Created by ludwing ixcayau on 12/04/2015.
 */
public class ProductoSQLiteHelper extends SQLiteOpenHelper {

        //Sentencia SQL para crear la tabla de Usuarios
        String sqlCreate = "CREATE TABLE Producto (nombre TEXT, tipo TEXT, precio INTEGER, cantidad INTEGER);";

        public ProductoSQLiteHelper(Context contexto, String nombre,CursorFactory factory, int version) {
